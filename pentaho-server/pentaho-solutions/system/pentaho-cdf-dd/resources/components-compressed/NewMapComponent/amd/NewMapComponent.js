define("cde/components/NewMapComponent/Map.lifecycle",["amd!cdf/lib/underscore"],function(e){
...
},_concludeUpdate:function(){this.postExec(),this.maybeToggleBlock(!1)}}}),define("cde/components/NewMapComponent/Map.selector",[],function(){
...
this}}}),define("cde/components/NewMapComponent/model/MapModel",["cdf/lib/BaseSelectionTree","amd!cdf/lib/underscore","cdf/lib/jquery"],function(e,t,o){
...
}),define("cde/components/NewMapComponent/_getMapping",["amd!cdf/lib/underscore"],function(e){
...
}),define("cde/components/NewMapComponent/FeatureStore/shapeConversion",[],function(){
"use strict";return{simplifyPoints:function(e,t){function o(e,t){var i=e[0],a=e[e.length-1];
if(e.length<3)return e;for(var r=-1,s=0,l=1;l<e.length-1;l++){var c=n(e[l],i,a);c>s&&(s=c,
r=l)}if(s>t){var p=e.slice(0,r+1),d=e.slice(r),u=o(p,t),h=o(d,t),m=u.slice(0,u.length-1).concat(h);
...
}}}),define("cde/components/NewMapComponent/FeatureStore/resolveShapes",["cdf/lib/jquery","amd!cdf/lib/underscore","./shapeConversion"],function(e,t,o){
...
l.resolve(o)}),l.promise()}return n}),define("cde/components/NewMapComponent/FeatureStore/resolveMarkers",["cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t){
...
latitude:o,longitude:t}},type:"Feature"};return n}return o}),define("cde/components/NewMapComponent/Map.model",["cdf/lib/jquery","amd!cdf/lib/underscore","cdf/Logger","./model/MapModel","./_getMapping","./FeatureStore/resolveShapes","./FeatureStore/resolveMarkers"],function(e,t,o,n,i,a,r){
...
i>=0&&i<o.length?o[i]:n}}}),define("cde/components/NewMapComponent/Map.configuration",["cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t){
...
r}return{getConfiguration:o}}),define("cde/components/NewMapComponent/Map.ext",["pentaho/environment"],function(e){
return{getMarkerImgPath:function(){return e.server.root+"api/repos/pentaho-cdf-dd/resources/components/NewMapComponent/amd/images/";
}}}),define("cde/components/NewMapComponent/Map.featureStyles",["cdf/lib/jquery","amd!cdf/lib/underscore","./Map.ext","cdf/Logger"],function(e,t,o,n){
...
"z-index":1}}};return{getStyleMap:i}}),define("cde/components/NewMapComponent/Map.colorMap",["amd!cdf/lib/underscore"],function(e){
...
return"rgba("+i.join(",")+")"}}}),define("text!cde/components/NewMapComponent/ControlPanel/ControlPanel.html",[],function(){
...
}),define("cde/components/NewMapComponent/ControlPanel/ControlPanel",["cdf/lib/jquery","amd!cdf/lib/underscore","cdf/lib/mustache","cdf/lib/BaseEvents","../model/MapModel","text!./ControlPanel.html","css!./ControlPanel"],function(e,t,o,n,i,a){
...
}})}),define("cde/components/NewMapComponent/Map.tileServices",["cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t){
...
apple:{minZoom:3,maxZoom:14}}}}),define("cde/components/NewMapComponent/engines/MapEngine",["cdf/lib/jquery","amd!cdf/lib/underscore","cdf/lib/BaseEvents","../model/MapModel"],function(e,t,o,n){
...
a=0},n||i.options.controls.doubleClickTimeoutMilliseconds||300)}}})}),define("cde/components/NewMapComponent/engines/google/MapComponentAsyncLoader",["cdf/lib/jquery"],function(e){
...
}return t=a.promise()}}(e)}),define("cde/components/NewMapComponent/engines/openlayers2/MapEngineOpenLayers",["cdf/lib/jquery","amd!cdf/lib/underscore","../MapEngine","cdf/lib/OpenLayers","../../model/MapModel","../google/MapComponentAsyncLoader","css!./styleOpenLayers2"],function(e,t,o,n,i,a){
...
activate:function(o){o.object.unselectAll();var n=t.union(o.object.layers[0].features,o.object.layers[1].features),i=e.model.getSelectedItems();
t.each(n,function(e){var n=e.attributes.model.get("id");t.contains(i,n)&&o.object.select(e);
}),e._updateDrag(!1)},boxselectionstart:function(e){e.object.unselectAll()},boxselectionend:function(o){
t.each(o.layers,function(e){t.each(e.selectedFeatures,function(e){s(e.attributes.model);
})}),o.object.unselectAll(),e.trigger("engine:selection:complete")}})},_addControlZoomBox:function(){
this.controls.zoomBox=new n.Control.ZoomBox({zoomOnClick:!1}),this.map.addControl(this.controls.zoomBox);
var e=this;this.controls.zoomBox.events.on({activate:function(t){e._updateDrag(!1);
}}),this.__patchDragHandler(this.controls.zoomBox.handler.dragHandler)},_addControlHover:function(){
function e(e){var o={featurehighlighted:"mouseover",featureunhighlighted:"mouseout"
};if(o[e.type]){var n=e.feature.attributes.model;n.setHover("mouseover"===o[e.type]),
...
var i=e.call(o,n);o.trigger(t,i)})})}})}),define("cde/components/NewMapComponent/engines/google/MapOverlay",["cdf/lib/jquery"],function(e){
...
this.setMap(a)}return t}),define("cde/components/NewMapComponent/engines/google/MapEngineGoogle",["cdf/lib/jquery","amd!cdf/lib/underscore","../MapEngine","./MapComponentAsyncLoader","../../model/MapModel","./MapOverlay","css!./styleGoogle"],function(e,t,o,n,i,a){
...
var r;return r=t.isArray(n)?i._selectUrl(t.template("${z}/${x}/${y}",{interpolate:/\$\{(.+?)\}/g
})({x:e.x,y:e.y,z:o}),n):n,t.template(r,{interpolate:/\$\{(.+?)\}/g})({x:e.x,y:e.y,
z:o})}},o))},showPopup0:function(o,n,i,r,s,l,c){l&&l.length>0&&(s=e("#"+l).html());
var p=new a(n.getGeometry().get(),r,i,s,l,this.map,c);this._popups=this._popups||[],
t.each(this._popups,function(e){e.setMap(null)}),this._popups.push(p)},showPopup:function(e,o,n,i,a,r,s){
var l=new google.maps.InfoWindow({content:a,position:o.getGeometry().get(),maxWidth:i
});this._popups=this._popups||[],t.each(this._popups,function(e){e.close()}),l.open(this.map),
this._popups.push(l)},registerViewportEvents:function(){function e(){function e(e){
var t={latitude:e.lat(),longitude:e.lng()};return t}function t(t){o=t?{northEast:e(t.getNorthEast()),
southWest:e(t.getSouthWest())}:{northEast:{},southWest:{}}}var o=t(this.map.getBounds()),n={
...
o.trigger(t,n)})})}})}),define("cde/components/NewMapComponent/addIns/LocationResolver/geonames/geonames",["cdf/AddIn","cdf/Dashboard.Clean","cdf/lib/jquery"],function(e,t,o){
...
n}),define("cde/components/NewMapComponent/addIns/LocationResolver/nominatim/nominatim",["cdf/AddIn","cdf/Dashboard.Clean","cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t,o,n){
...
i}),define("cde/components/NewMapComponent/addIns/LocationResolver/mapquest/mapquest",["cdf/lib/jquery","cdf/AddIn","cdf/Dashboard.Clean","../nominatim/nominatim"],function(e,t,o,n){
...
}),define("cde/components/NewMapComponent/addIns/MarkerImage/cggMarker/cggMarker",["cdf/AddIn","cdf/Dashboard.Clean","cdf/components/CggComponent.ext"],function(e,t,o){
...
n}),define("cde/components/NewMapComponent/addIns/MarkerImage/urlMarker/urlMarker",["cdf/AddIn","cdf/Dashboard.Clean","../../../Map.ext"],function(e,t,o){
...
}};return t.registerGlobalAddIn("NewMapComponent","MarkerImage",new e(n)),n}),define("cde/components/NewMapComponent/addIns/ShapeResolver/simpleJSON",["cdf/AddIn","cdf/Dashboard.Clean","cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t,o,n){
...
a}),define("cde/components/NewMapComponent/addIns/ShapeResolver/kml",["cdf/AddIn","cdf/Dashboard.Clean","cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t,o,n){
...
r}),define("cde/components/NewMapComponent/addIns/ShapeResolver/geoJSON",["cdf/AddIn","cdf/Dashboard.Clean","cdf/Logger","cdf/lib/jquery","amd!cdf/lib/underscore"],function(e,t,o,n,i){
...
}this.mapEngine.showPopup(o.data,o.feature,a,r,s,this.popupContentsDiv,l)}}})}),define("cde/components/NewMapComponent",["cde/components/NewMapComponent/NewMapComponent"],function(e){
return e});