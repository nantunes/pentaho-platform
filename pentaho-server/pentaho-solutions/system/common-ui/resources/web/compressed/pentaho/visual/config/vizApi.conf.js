...
return e.isOn()?e.color:n().toGrayScale(e.color)}function i(e,i){var t=i>=1e3,l=t+"|"+e,a=x[l];
if(!a){var s=e?"."+new Array(e+1).join("0"):".##",o="#,0"+s+(t?" A":"");a=n().data.numberFormat(o),
a.style(g),x[l]=a}return a}function t(){var e=this.delegate();if(e){e=e.rgb();var i=s(this);
!i.isActive&&i.isSelected<0?e=o().color(v):i.isActive&&i.isSelected>-1&&(e=e.hsl(),
e=e.lightness(.8*e.l))}return this.finished(e)}function l(){var e=this.delegate();
if(e){e=e.rgb();var i=s(this);i.isActive?i.isActive&&i.isSelected>0&&(e=e.hsl(),e=e.lightness(.8*e.l)):i.isSelected<0?(e=o().color(v),
e=e.alpha(.75)):e=e.alpha(.5)}return this.finished(e)}function a(){var e=this.delegate();
...
return y.isSelected=i.showsSelection()&&t.anySelected()?t.isSelected()?1:-1:0,y.isActive=i.mayShowActive(t,!0)?1:0,
y}function n(){return p||(p=require("cdf/lib/CCC/pvc"))}function o(){return d||(d=require("cdf/lib/CCC/protovis"));
}var c=-5,r=-1,p=null,d=null,u="10px OpenSansRegular",h=117,x={},g={group:" ",abbreviations:["k","M","G","T","P","E","Z","Y"],
subAbbreviations:["m","µ","n","p","f","a","z","y"]},y={isSelected:0,isActive:0},v="rgb(234,234,234)";
return{rules:[{priority:c,select:{module:["pentaho/visual/models/Line","pentaho/visual/models/BarLine"]
},apply:{props:{lineWidth:{defaultValue:2}}}},{priority:c,select:{module:"pentaho/visual/models/HeatGrid"
},apply:{props:{colorSet:{defaultValue:"blue"}}}},{priority:c,select:{module:"pentaho/visual/models/MetricPointAbstract"
},apply:{props:{colorSet:{defaultValue:"ryg"}}}},{priority:c,select:{module:"pentaho/ccc/visual/Abstract"
},apply:{extension:{margins:0,paddings:10,format:{number:{style:g}},multiChartMax:50,
...
titleFont:u,label_ibits:0,label_imask:"ShowsActivity"}}},{priority:c,select:{module:"pentaho/ccc/visual/CartesianAbstract"
...
}}},{priority:c,select:{module:["pentaho/ccc/visual/Bar","pentaho/ccc/visual/BarStacked","pentaho/ccc/visual/BarNormalized","pentaho/ccc/visual/PointAbstract","pentaho/ccc/visual/BarLine","pentaho/ccc/visual/Boxplot","pentaho/ccc/visual/Waterfall"]
},apply:{extension:{xAxisSizeMax:90}}},{priority:c,select:{module:["pentaho/ccc/visual/Bar","pentaho/ccc/visual/BarStacked","pentaho/ccc/visual/BarNormalized","pentaho/ccc/visual/PointAbstract","pentaho/ccc/visual/BarLine","pentaho/ccc/visual/Waterfall","pentaho/ccc/visual/Boxplot","pentaho/ccc/visual/MetricPointAbstract"]
},apply:{extension:{yAxisSize:57,contentPaddings:{right:75}}}},{priority:c,select:{
module:"pentaho/ccc/visual/MetricPointAbstract"},apply:{extension:{xAxisSize:30,autoPaddingByDotSize:!0,
axisOffset:0,dot_lineWidth:0,dot_fillStyle:l}}},{priority:c,select:{module:"pentaho/ccc/visual/Bubble"
...
return this.finished(e)},dot_strokeStyle:l,dot_shapeSize:function(){var e=this.panel.visualRoles.size.isBound()?this.delegate():25;
return this.finished(e)},dot_DefaultVisible:function(){return this.finished(!0)}}
}},{priority:c,select:{module:"pentaho/ccc/visual/Scatter"},apply:{extension:{dot_shapeRadius:function(){
return this.finished(5)}}}},{priority:c,select:{module:["pentaho/ccc/visual/BarHorizontal","pentaho/ccc/visual/BarStackedHorizontal","pentaho/ccc/visual/BarNormalizedHorizontal"]
},apply:{extension:{xAxisPosition:"top",xAxisSize:30,yAxisSizeMax:h,contentMargins:{
right:30}}}},{priority:c,select:{module:"pentaho/ccc/visual/BarAbstract"},apply:{
extension:{barSizeRatio:.92,barSizeSpacing:2,barSizeMin:4,barSizeMax:150,bar_lineWidth:function(){
return this.finished(0)},bar_fillStyle:t}}},{priority:c,select:{module:"pentaho/ccc/visual/PointAbstract"
...
return e-i}return e},linesVisible:!1}}},{priority:c,select:{module:["pentaho/ccc/visual/PointAbstract","pentaho/ccc/visual/BarLine"]
...
pointLine_imask:"ShowsActivity"}}},{priority:c,select:{module:"pentaho/ccc/visual/AreaAbstract"
},apply:{extension:{linesVisible:!1}}},{priority:c,select:{module:"pentaho/ccc/visual/Area"
},apply:{extension:{area_fillStyle:l}}},{priority:c,select:{module:"pentaho/ccc/visual/AreaStacked"
},apply:{extension:{area_fillStyle:a}}},{priority:c,select:{module:"pentaho/ccc/visual/Pie"
...
slice_lineWidth:0,slice_strokeStyle:"white",slice_fillStyle:t}}},{priority:c,select:{
module:"pentaho/ccc/visual/Donut"},apply:{extension:{slice_innerRadiusEx:"60%"}}},{
priority:c,select:{module:"pentaho/ccc/visual/HeatGrid"},apply:{extension:{useShapes:!0,
...
}}},{priority:c,select:{module:"pentaho/ccc/visual/Sunburst"},apply:{extension:{rootCategoryLabel:"",
...
return this.finished(2)},slice_fillStyle:t}}},{priority:c,select:{module:"pentaho/ccc/visual/Treemap"
},apply:{extension:{valuesVisible:!0}}},{priority:r,select:{application:"pentaho-det",
module:"pentaho/ccc/visual/Abstract"},apply:{extension:{selectable:!1}}},{priority:r,
...
}}},{priority:r,select:{application:"pentaho-cdf",module:"pentaho/ccc/visual/Abstract"
},apply:{extension:{valuesVisible:!1,valuesFont:u,legend$Dot_shapeSize:9,legend$Dot_lineWidth:2,
legendMarkerSize:8}}},{priority:r,select:{application:["pentaho-det","pentaho-cdf"],
module:"pentaho/ccc/visual/PointAbstract"},apply:{extension:{dotsVisible:!1,dot_shapeRadius:function(){
return this.finished(5)}}}},{priority:r,select:{application:["pentaho-det","pentaho-cdf"],
module:"pentaho/ccc/visual/CartesianAbstract"},apply:{extension:{axisFont:u,axisLabel_textStyle:"#666",
axisTitleSize:18,axisTitleFont:u,axisTitleLabel_textStyle:"#666"}}},{priority:r,select:{
application:"pentaho-cdf",module:"pentaho/ccc/visual/BarAbstract"},apply:{extension:{
label_textMargin:7}}},{priority:r,select:{application:["pentaho-analyzer","pentaho-det"],
...
return arguments.length>2?String(e):i}}}},{priority:r,select:{application:["pentaho-analyzer","pentaho-det"],
module:"pentaho/ccc/visual/HeatGrid"},apply:{extension:{xAxisBandSizeMin:30}}},{priority:r,
...
priority:r,select:{application:"pentaho-cdf",module:"pentaho/ccc/visual/Bubble"},
