...
value:void 0,writable:!1,configurable:!1,enumerable:!1},m=Object.prototype,g=Object.prototype.isPrototypeOf,y="___OBJUID___",v=1;
...
e},getPropertyDescriptor:o,lca:function(e,t){if(!e||!t)return null;for(var n=t;e!==n&&n!==m&&!g.call(n,e)&&(n=Object.getPrototypeOf(n)););
return n!==m||g.call(n,e)||(n=null),n},make:function(e,t){switch(t?t.length:0){case 0:
...
return k.call(e,"__base_class_id__")?e.__base_class_id__:t?e.__base_class_id__=N++:null;
...
writable:!0,enumerable:!1,value:T}),t.setConst(u,"__base_root_proto__",u),D(a,i),
...
return o?(o=F(o,r,e.__base_root_proto__,i,!0),t.setConst(e,"__base_init__",o)):o=m(r,i),
i&&D(o,i),o}function _(e){var t=e&&e.constructor;return t&&t!==Object&&n.is(t)?t:null;
}function m(e,t){if(!t||!K)return function(){return e.apply(this,arguments)};var n=new Function("init","return function "+g(t)+"() {\n  return init.apply(this, arguments);\n};");
return n(e)}function g(e){return e.replace(/[^\w0-9$_]/gi,"_")}function y(e){return e instanceof this?e:t.make(this,arguments);
...
}return t.applyClass(e,this,L.call(arguments,1))}function b(e,t,n){return this.prototype.__base_ops__.push({
...
this):(e&&r.extend(e,i),t&&S.call(this,t,i),this)}function O(e){for(var n=t.lca(this.prototype,e.prototype),i=[],r=e.prototype;r!==n;)i.push(r),
...
var e=this.prototype;e.__base_ops__.push({name:"implement",args:L.call(arguments)
...
}function j(){this.prototype.__base_ops__.push({name:"implementStatic",args:L.call(arguments)
});for(var e=-1,t=arguments.length;++e<t;){var n=arguments[e];n&&S.call(this,n)}return this;
}function S(e,i){var r,o=i&&i.exclude;if(n.is(e)){var a=t.lca(this.prototype,e.prototype),s=a&&a.constructor;
...
}function T(){}function I(e,n){if(e){var i=this,r=this.__base_root_proto__,o=this.__base_extend_exclude__,a=r&&t.lca(e,this);
...
R.call(i,t,e,r,null,a))},f=this.__base_extend_order__;if(f)for(var _=-1,m=f.length;++_<m;)(c=f[_])in e&&p(c);
...
}function F(e,t,n,i,r){if(!e)return t;var o=e.valueOf();if(!t){if(o!==e)return e;t=T;
...
}finally{this.base=n}}}function P(e,t,n,i){if(!i||!K)return $(e,t,n);var r;return(r=n?new Function("_method_","_baseMethod_","_rootProto_","return function "+g(i)+"() {\n  var previous = _rootProto_.base; _rootProto_.base = _baseMethod_;\n  try {\n      return _method_.apply(this, arguments);\n  } finally { _rootProto_.base = previous; }\n};"):new Function("_method_","_baseMethod_","_rootProto_","return function "+g(i)+"() {\n  var previous = this.base; this.base = _baseMethod_;\n  try {\n     return _method_.apply(this, arguments);\n  } finally { this.base = previous; }\n};"))(e,t,n);
}function B(){return V.call(this.valueOf())}function D(e,t){e.displayName=t;try{Object.defineProperty(e,"name",{
value:t,configurable:!0})}catch(n){}}var V=Function.prototype.toString,k=Object.prototype.hasOwnProperty,L=Array.prototype.slice,N=1,q=Object.freeze({
...
q+=2,2===q&&L()}function r(){var e=process.nextTick,t=process.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/);
...
try{e.call(t,n,i)}catch(r){return r}}function m(e,t,n){z(function(e){var i=!1,r=_(n,t,function(n){
i||(i=!0,t!==n?v(e,n):C(e,n))},function(t){i||(i=!0,O(e,t))},"Settle: "+(e._label||" unknown promise"));
!i&&r&&(i=!0,O(e,r))},e)}function g(e,t){t._state===Y?C(e,t._result):t._state===Z?O(e,t._result):x(t,void 0,function(t){
v(e,t)},function(t){O(e,t)})}function y(e,n){if(n.constructor===e.constructor)g(e,n);else{
var i=f(n);i===X?O(e,X.error):void 0===i?C(e,n):t(i)?m(e,n,i):C(e,n)}}function v(t,n){
...
r=t[a+n],i?S(n,i,r,o):r(o);e._subscribers.length=0}}function A(){this.error=null}
function j(e,t){try{return e(t)}catch(n){return ee.error=n,ee}}function S(e,n,i,r){
var o,a,s,u,l=t(i);if(l){if(o=j(i,r),o===ee?(u=!0,a=o.error,o=null):s=!0,n===o)return void O(n,p());
}else o=r,s=!0;n._state!==Q||(l&&s?v(n,o):u?O(n,a):e===Y?C(n,o):e===Z&&O(n,o))}function T(e,t){
...
O(r,e)}var i=this,r=new i(h);if(!N(e))return O(r,new TypeError("You must pass an array to race.")),
...
h!==e&&(t(e)||$(),this instanceof B||P(),T(this,e))}function D(){var e;if("undefined"!=typeof global)e=global;else if("undefined"!=typeof self)e=self;else try{
...
}var V;V=Array.isArray?Array.isArray:function(e){return"[object Array]"===Object.prototype.toString.call(e);
};var k,L,N=V,q=0,z=({}.toString,i),K="undefined"!=typeof window?window:void 0,U=K||{},W=U.MutationObserver||U.WebKitMutationObserver,G="undefined"!=typeof process&&"[object process]"==={}.toString.call(process),H="undefined"!=typeof Uint8ClampedArray&&"undefined"!=typeof importScripts&&"undefined"!=typeof MessageChannel,J=new Array(1e3);
L=G?r():W?a():H?s():void 0===K&&"function"==typeof require?c():u();var Q=void 0,Y=1,Z=2,X=new A,ee=new A;
I.prototype._validateInput=function(e){return N(e)},I.prototype._validationError=function(){
...
S(i,r,a,o)})}else x(n,r,e,t);return r},"catch":function(e){return this.then(null,e);
}};var ue=D,le={Promise:se,polyfill:ue};"function"==typeof define&&define.amd?define("pentaho/shim/_es6-promise/es6-promise",[],function(){
...
var n=f.moduleMetaService.get(t);return null!==n?n.loadAsync():s.require(t,e)}var m=0,g=n.extend(t.id,{
...
this.addRule(e,t)},this)}},addRule:function(e,t){e._ordinal=m++;var n=e.select||{},o=n.module||n.instance||n.type;
...
var c=null,d=null,m=function(e){var t=f.moduleMetaService.getId(e)||e,n=a.getOwn(d,t,null);
return null===n&&(n=c.length,d[t]=n,c.push(_(t))),n},g=function(e){var t=u.is(e.apply),n=t?[]:null;
return e.deps&&(null===c&&(c=[],d=Object.create(null)),e.deps.forEach(function(e){
var i=m(e);t&&n.push(i)})),t?h(e.apply,n):u.constant(e.apply)},y=s.map(g);return null!==i&&y.unshift(u.constant(i)),
Promise.all(c||[]).then(function(e){return y.reduce(function(t,n){var i=n(e);return o.merge(t,i);
},{})})}});return g}}),define("pentaho/_core/Core",["require","module","./module/MetaService","./module/Meta","./module/InstanceMeta","./module/TypeMeta","./module/Service","./config/Service"],function(e,t,n,i,r,o,a,s){
...
_.TypeModuleMeta=o(_),_.InstanceModuleMeta=r(_);var m=n(_);return _.moduleMetaService=new m,
...
return f(e,n);case"function":return m(e,n);case"object":return Array.isArray(e)?y(e,n):v(e,t,n);
...
return h.is(n)&&g(n)?l["return"](n,t):l.error(c.operInvalid("typeRef","The value of module '"+e+"' is not a '"+A+"' constructor."),t);
}function m(e,t){return g(e)?l["return"](e,t):l.error(c.argInvalid("typeRef","Function is not a '"+A+"' constructor."),t);
}function g(e){var t=d(A);return e===t||e.prototype instanceof t}function y(e,t){
...
$type:t});return null!==e&&i.specContext.add(a.type,e),a})}var x="pentaho/type/",w=x+"Complex",A=x+"Instance",j=x+"String",S=x+"Boolean",T=x+"Number",I=x+"List",R=Object.create(null),E=new o,F=n.extend(t.id,{
...
switch(typeof e){case"string":r=d(j);break;case"number":r=d(T);break;case"boolean":
r=d(S)}if(null===r||null==n||r.type.isSubtypeOf(n)||(r=null),null===r){if(null==n)throw c.operInvalid("Cannot create instance of unspecified type.");
...
e}function m(e,t,n){return function(i){var r=e.apply(this,arguments);return _.call(i,r,t,n);
}}var g=1,y=["description","category","helpUrl","isBrowsable","isAdvanced","ordinal"],v=Object.prototype.isPrototypeOf,b=null,C=a.extend("pentaho.type.Type",{
extend_order:["mixins"],constructor:function(e,t){e||(e={}),l.setConst(this,"uid",g++);
...
var e;c.is(u)?(e=u,u=null,n&&(e=m.call(a,e,n,u))):(u=_.call(a,u,n,null),e=c.constant(u)),
...
if(c.is(t))s=t,n&&(s=m.call(this,s,n,u));else{if(t=_.call(this,t,n,null),null==t)return;
s=c.constant(t)}this[r]=t,this[o]=i(this[o],s)}}}),a[e+"On"]=function(e){return this[o].call(e,this);
...
}function p(e){return e.isCanceled}var f=[],_=1,m=a.extend(e.id,{constructor:function(){
...
}:function(e){e.owner._onChangeDid(e)};f.push(this),m.enterCommitted().using(this.__eachChangeset.bind(this,i));
var r=f.pop();if(r!==this)throw c.operInvalid("Unbalanced transaction exit commit did.");
return n}},{get current(){return t.current},enter:function(){var e=t.current||new m;
...
null!==a&&(t||(t=[])).push(a)}return t}});return m}),define("pentaho/type/util",["pentaho/util/object"],function(e){
...
return null}function m(e){return e instanceof Array?e:e.indexOf(",")>-1?e.split(/\s*,\s*/):[e];
}function g(e){return e.isCanceled}function y(e,t,n,i){var r=n+("__"!==i?":"+i:""),o=e?" Error: "+e.message:"";
s.log("Event listener of '"+r+"' failed."+o)}var v=Object.prototype.hasOwnProperty,b={
isCanceled:g,errorHandler:null},C={isCanceled:g,errorHandler:y};return u.prototype.remove=function(){
this.dispose()},t.extend(e.id,{__observersRegistry:null,on:function(e,t,n){if(!e)throw r.argRequired("type");
if(!t)throw r.argRequired("observer");var i=m(e);if(i&&i.length){var o=n&&n.priority||0,s=!(!n||!n.isCritical);
...
if(!t)throw r.argRequired("observer");var n=m(e);if(n&&n.length){var o=a.is(t)?f:_;
...
null===p?f.apply(e,t):p(f,e,t,_)}catch(m){if(c[_].isCritical)throw m;d.call(e,m,t,n,a);
...
for(var _,m=[],g=d.length;g--;)null!=(_=d[g].observer[p])&&m.push(u(_));return d.emittingLevel--,
Promise.all(m).then(function(){})}})}),define("pentaho/type/mixins/changeset",["pentaho/util/error"],function(e){
...
},__set:function(e,t,o,a,s,l){this._assertWritable();var c,h,d,p=this.__projectedMock,f=p.__elems,_=p.__keys,m=this.owner.$type.elementType,g=this.owner.$isReadOnly,y=this.owner.__needReadOnlyElementValidation;
l=null==l?f.length:0>l?Math.max(0,f.length+l):Math.min(l,f.length);for(var v=Array.isArray(e)?e.map(m.to,m):[m.to(e)],b={},C=[],O=[],x=-1,w=v.length;++x<w;)if(null!=(h=v[x]))if(d=h.$key,
...
value:h,to:O.length})):(v.splice(x,1),--w,--x);var j,S=0;for(x=-1,w=f.length;++x<w;)h=f[x],
d=h.$key,u.hasOwn(b,d)&&4!==b[d]?(null==j&&(j=x-S),C.push(d)):a?(l>x&&--l,g&&this.owner.__assertEditable(),
this.__addChange(new i([h],x-S)),++S):C.push(d);if(null==j&&O.length>0&&(j=l),t)for(x=-1,
w=O.length;++x<w;){var T=O[x],I=l+T.to;if(g&&this.owner.__assertEditable(),y&&!T.value.$type.isReadOnly)throw new TypeError("List requires elements of a read-only type.");
this.__addChange(new n(T.value,I)),C.splice(I,0,T.value.$key)}var R=0;if(s)for(x=-1,
w=v.length;++x<w;)if(null!=(h=v[x])){var E=C.indexOf(h.$key);if(j>E&&--j,j+x>E||R>E){
var F=Math.max(j+x,R);g&&this.owner.__assertEditable(),this.__addChange(new r([h],E,F)),
...
d=0;do{var m=h[d];f&&m.from===_-1||(f&&this.__addChange(new i(f,_)),f=[]),f.unshift(m.value),
_=m.from}while(++d<p);f&&this.__addChange(new i(f,_))}},__removeAt:function(e,t){
...
},combine:function(e,t){return function(n){var i=e.call(this,n);if(i&&!i.length)return i;
var r=t.call(this,n);return r?i&&r.length?n.valueType.elementType.__intersect(i,r):r:i;
...
"use strict";function p(e){return e=+e,isNaN(e)||0>e?void 0:Math.floor(e)}var f,_="pentaho/type/String",m=t.extend({
...
value:!1,cast:Boolean,combine:function(e,t){return function(n){return e.call(this,n)||t.call(this,n);
}}},countMin:{value:0,cast:p,combine:function(e,t){return function(n){return Math.max(e.call(this,n),t.call(this,n));
}}},countMax:{value:1/0,cast:p,combine:function(e,t){return function(n){return Math.min(e.call(this,n),t.call(this,n));
}}},isApplicable:{value:!0,cast:Boolean,combine:function(e,t){return function(n){
return e.call(this,n)&&t.call(this,n)}}},isEnabled:{value:!0,cast:Boolean,combine:function(e,t){
return function(n){return e.call(this,n)&&t.call(this,n)}}}},countRangeOn:function(e){
...
}}).configure({$type:e.config});return f=m.type,f.__setValueType(n),m}),define("pentaho/lang/Collection",["./List","../util/object"],function(e,t){
...
}}},{__setElement:function(e,n,o,a){var l=e.$type,c=n.name,h=e.__getByName(c),d=e.__getStateByName(c),p=null==o?s:u,f=n.toValueOn(e,o),_=e.$changeset,m=null;
null!==_&&(m=_.__getChange(c),null!==m&&m instanceof t&&(m=null));var g=null!==m?m.value:h,y=null!==m?m.state:d,v=a?!1:l.areEqual(f,g);
if(p!==y||!v){if(n.isReadOnly)throw new TypeError("'"+c+"' is read-only.");if(null!==m)return void(p===d&&l.areEqual(f,h)?_.__removePrimitiveChange(c):_.__updateReplaceChange(c,v?g:f,p));
var b=r.enter();null===_&&(_=b.transaction.ensureChangeset(e)),_.__setPrimitiveChange(c,new i(n,v?g:f,p,h)),
...
"use strict";var l="pentaho/type/",c=l+"String",h=l+"Boolean",d=l+"Number",p=null,f=null,_=null,m=n.extend({
constructor:function(e){var t,n;e instanceof Object?e.constructor===Object?(void 0===(t=e.value)&&(t=e.v),
void 0===(n=e.formatted)&&(n=e.f)):e instanceof m?(t=e.value,n=e.formatted):t=e:t=e,
...
if(e instanceof Object){if(e.constructor===Object)return e;if(e instanceof m)return{
...
n}}}).localize({$type:u.structured.Simple}).configure({$type:t.config});return m}),
...
"use strict";return t.extend({_toJSONValue:function(e){return this.value.toJSON();
},$type:{id:e.id,cast:function(e){return n.parseDateEcma262v7(e)},get isContinuous(){
return!0}}}).localize({$type:i.structured.Date}).configure({$type:e.config})}),define("pentaho/type/Object",["pentaho/module!_","./Simple","pentaho/util/object","pentaho/i18n!types"],function(e,t,n,i){
...
void(n!==t&&s.__setElement(this,e,n,!0)))}function m(e,t){return e[t.index]}function g(e,t){
...
this._initContainer(),this._initProperties(e)},_initProperties:function(e){var t=this.$type.__getProps(),n=t.length,i=e?Array.isArray(e)?m:g:void 0,r={},o={};
...
nameAlias:"ci",valueType:"boolean",defaultValue:!1}]}})}}),define("pentaho/data/filter/Abstract",["module","pentaho/type/Complex","./_core/Tree","./_core/And","./_core/Or","./_core/Not","./_core/True","./_core/False","./_core/Property","./_core/IsEqual","./_core/IsIn","./_core/IsGreater","./_core/IsLess","./_core/IsGreaterOrEqual","./_core/IsLessOrEqual","./_core/IsLike","pentaho/util/arg","pentaho/util/error","pentaho/util/object","pentaho/util/logger","pentaho/debug","pentaho/debug/Levels"],function(e,t,n,i,r,o,a,s,u,l,c,h,d,p,f,_,m,g,y,v,b,C){
...
});break;default:e=new M.Or({operands:[new M.And({operands:[e]})]})}return e}function S(e){
return"or"===e.kind?T(e):e}function T(e){for(var t={},n=[],i=-1,r=e.operands,o=r.count;++i<o;){
...
throw g.notImplemented("This case is not supported.")}E(p.value,c.value)||(n=e.operands.toArray(),
...
e},visit:function(e){if(!e)throw g.argRequired("transformer");return e(this)||this._visitDefault(e);
},_visitDefault:function(e){return this},negate:function(){return new M.Not({operand:this
})},or:function(){if(!arguments.length)return this;var e=m.slice(arguments);return e.unshift(this),
new M.Or({operands:e})},and:function(){if(!arguments.length)return this;var e=m.slice(arguments);
...
var e=this.__toDnfCache;return e||(this.__toDnfCache=e=this.visit(O).visit(x).visit(A).visit(j).visit(S),
e.__toDnfCache=e),e},toExtensional:function(e,t){function n(e,t){var n={};return t.forEach(function(t){
var i=e.getColumnIndexById(t);if(-1===i)throw g.argInvalid("keyColumnNames","The column name "+t+" is not in the dataPlain.");
n[t]=i}),n}F&&v.log("toExtensional BEGIN");try{var i=e.filter(this),r=i.getNumberOfRows();
if(0===r)return M.False.instance;if(0===t.length)throw g.argInvalid("keyColumnNames","At least one key column must be specified.");
...
"use strict";function i(e,n,i){var o=e.getColumnIndexById(n);if(o>=0){var a;return a=null==i?null:{
_:e.getColumnType(o),value:r.getCellValue(i),formatted:i.toString()},new t({property:n,
value:a})}return null}var r={hasAnyKeyColumns:function(e){for(var t=-1,n=e.getNumberOfColumns();++t<n;)if(e.isColumnKey(t))return!0;
...
}).configure({$type:e.config});return o}),define("pentaho/visual/role/AbstractProperty",["pentaho/module!_","pentaho/type/Property","./AbstractMapping","pentaho/i18n!messages","pentaho/type/loader","pentaho/type/ValidationError","pentaho/data/TableView","pentaho/type/util"],function(e,t,n,i,r,o,a,s){
"use strict";var u=t.extend({$type:{id:e.id,valueType:n,defaultValue:function(){return{};
...
}),e},hasAnyModes:function(e){var t=e.isContinuous,n=e.isList,i=e.elementDataType?r.resolveType(e.elementDataType).type:null,o=!1;
return this.modes.each(function(e){return null!=t&&e.isContinuous!==t||null!=n&&e.dataType.isList!==n||null!=i&&!i.isSubtypeOf(e.dataType.elementType)?void 0:(o=!0,
!1)}),o},validateOn:function(e){var t=this.base(e);if(!t){var n=function(e){t=s.combineErrors(t,e);
},i=e.get(this);!t&&i.hasFields&&this.__validateFieldsOn(e,i,n)}return t},__validateFieldsOn:function(e,t,n){
for(var r=e.data,a=-1,s=t.fields,u=s.count;++a<u;){var l=s.at(a),c=l.name,h=r?r.getColumnIndexById(c):-1;
0>h&&n(new o(i.format(i.structured.errors.property.fieldIsNotDefinedInAbstractModelData,{
name:c,role:this})))}}}}).localize({$type:i.structured.AbstractProperty}).configure({
$type:e.config});return u}),define("pentaho/visual/color/Level",["pentaho/module!_","pentaho/type/String","pentaho/type/mixins/Enum","pentaho/i18n!messages"],function(e,t,n,i){
...
}).configure({$type:e.config})}),define("pentaho/visual/base/AbstractModel",["pentaho/module!_","pentaho/type/Complex","../role/AbstractProperty","../color/PaletteProperty","./Application","pentaho/data/filter/Abstract","pentaho/type/Object","pentaho/util/object","pentaho/type/changes/ComplexChangeset","pentaho/i18n!model","pentaho/module/subtypesOf!pentaho/data/filter/Abstract"],function(e,t,n,i,r,o,a,s,u,l){
"use strict";var c=u.extend({_apply:function(e){this.base(e),this.__areDataOrMappingsChanged(e.$type)&&e._onDataOrMappingsChanged();
},__areDataOrMappingsChanged:function(e){for(var t=this.propertyNames,n=-1,i=t.length;++n<i;){
var r=t[n];if("data"===r)return!0;if(e.isVisualRole(e.get(r)))return!0}return!1}}),h=n.type,d=i.type,p=t.extend({
_createChangeset:function(e){return new c(e,this)},_onDataOrMappingsChanged:function(){
this.$type.eachVisualRole(function(e){this.get(e)._onDataOrMappingChanged()},this);
},get keyFieldNames(){var e=[],t=e.set=Object.create(null);return this.$type.eachVisualRole(function(n){
n.isVisualKey&&this.get(n).fields.each(function(n){var i=n.name;s.hasOwn(t,i)||(t[i]=!0,
e.push(i))})},this),e},get measureFieldNames(){var e=this.keyFieldNames.set,t=[],n=t.set=Object.create(null);
return this.$type.eachVisualRole(function(i){i.isVisualKey||this.get(i).fields.each(function(i){
var r=i.name;s.hasOwn(e,r)||s.hasOwn(n,r)||(n[r]=!0,t.push(r))})},this),t},toSpecInContext:function(e){
...
if(null!==n){var i=n.value.toPlainTable();return new a(i)}return n}},{name:"selectionFilter",
valueType:o,defaultValue:{_:"or"},isRequired:!0}],eachVisualRole:function(e,t){var n=0;
return this.each(function(i){return this.isVisualRole(i)&&e.call(t,i,n++,this)===!1?!1:void 0;
},this),this},isVisualRole:function(e){return e.isSubtypeOf(h)},isColorPalette:function(e){
return e.isSubtypeOf(d)}}}).localize({$type:l.structured.AbstractModel}).configure({
$type:e.config});return p}),define("pentaho/visual/role/Mode",["pentaho/module!_","pentaho/type/Complex","pentaho/i18n!messages"],function(e,t,n){
...
var n,i=e.map(function(e){return d.to(e)});if(n=null===this.__modes?i:d.__intersect(this.__modes.toArray(),i),
!n.length)throw c.argInvalid("modes",r.structured.errors.property.noModes);this.__modes=new p(n,{
...
get countMax(){return t.__fieldsCountMax},set countMax(e){t.__fieldsCountMax=e},countRangeOn:function(e){
return t.__fieldsCountRangeOn(e)}})}return e},set fields(e){if(null!=e){var t=this.fields;
...
return function(n){return e.call(this,n)||t.call(this,n)}}},__fieldsCountMin:{value:0,
cast:h,group:"fields",localName:"countMin",combine:function(e,t){return function(n){
return Math.max(e.call(this,n),t.call(this,n))}}},__fieldsCountMax:{value:function(e){
var t=this.get(e),n=t&&t.mode;return(null!==n?n.dataType.isList:e.hasAnyListModes)?1/0:1;
},cast:h,group:"fields",localName:"countMax",combine:function(e,t){return function(n){
return Math.min(e.call(this,n),t.call(this,n))}}}},__fieldsCountRangeOn:function(e){
var t=this.__fieldsIsRequiredOn(e),n=this.__fieldsCountMinOn(e),i=this.__fieldsCountMaxOn(e);
return t&&1>n&&(n=1),n>i&&(i=n),{min:n,max:i}},validateOn:function(e){var t=this.base(e);
...
n}}}).configure({$type:e.config});return f}),define("pentaho/visual/base/Model",["pentaho/module!_","./AbstractModel","../role/Property"],function(e,t){
"use strict";return t.extend({$type:{id:e.id,defaultView:"./View",isAbstract:!0}}).configure({
$type:e.config})}),define("pentaho/type/action/Base",["pentaho/module!_","../Element","pentaho/lang/OperationInvalidError","pentaho/util/object","pentaho/util/text","pentaho/i18n!../i18n/types"],function(e,t,n,i,r,o){
...
"use strict";var h="The `execute` method can only be called while in the 'unstarted' state.",d="The `done` method can only be called while in the 'do' state.",p="The `reject` method can only be called while in the 'init', 'will' or 'do' states.",f=n.init|n.will|n["do"],_=n.canceled|n.failed,m=n.did|_;
...
return 0!==(this.__state&m)},get isRejected(){return 0!==(this.__state&_)},get isCanceled(){
...
},isSubsetOf:function(e){var t=this.__bits;return 0!==t&&(t|e)===e}})}),define("pentaho/visual/base/View",["pentaho/module!_","pentaho/type/Complex","./Model","../action/Update","../action/Select","../action/Execute","pentaho/type/loader","pentaho/type/action/Execution","pentaho/type/action/impl/Target","pentaho/type/changes/ComplexChangeset","pentaho/type/changes/Transaction","pentaho/lang/UserError","pentaho/util/object","pentaho/util/arg","pentaho/util/fun","pentaho/util/BitSet","pentaho/util/error","pentaho/util/logger","pentaho/util/promise","pentaho/util/spec","pentaho/i18n!view","pentaho/module/subtypesOf!pentaho/visual/action/Base"],function(e,t,n,i,r,o,a,s,u,l,c,h,d,p,f,_,m,g,y,v,b){
"use strict";function C(e,t){var n=0;return t.split("And").forEach(function(t){var i=e.PropertyGroups[t];
null==i||isNaN(+i)?g.warn("There is no registered property group with name '"+t+"'."):n|=i;
}),n}var O=/^_update(.+)$/,x=s.extend({_onPhaseInit:function(){var e=this.target;if(null===e.__domContainer)throw m.operInvalid("The view has no domContainer.");
if(null!==e.__updateActionExecution)throw m.operInvalid("The view is already updating.");
...
get domContainer(){return this.__domContainer},set domContainer(e){if(!e)throw m.argRequired("domContainer");
if(this.__domContainer){if(e!==this.__domContainer)throw m.operInvalid("Cannot change 'domContainer' once set.");
...
g.warn("Auto-update was canceled: "+e)})},update:function(){var e=this.__updateActionExecution;
...
this.__extensionEf=e}return e}}},{createAsync:function(e){if(!e)return Promise.reject(m.argRequired("viewSpec"));
var t;if(e._)t=a.resolveTypeAsync(e._);else{var n=e.model;if(!n)return Promise.reject(m.argRequired("viewSpec.model"));
var i;if(n.constructor===Object){if(!n._)return Promise.reject(m.argRequired("viewSpec.model._"));
...
}):Promise.reject(m.argRequired("modelType"))},_subclassed:function(e,t,n,i){e.PropertyGroups=Object.create(this.PropertyGroups),
...
_createActionExecution:function(e){if(e instanceof i){if(null!==this.__updateActionExecution)throw m.operInvalid("An update action is already executing.");
...
});return i}),define("pentaho/visual/role/ExternalProperty",["pentaho/module!_","./AbstractProperty","./ExternalMapping","./Mode","pentaho/module/subtypesOf!pentaho/visual/role/adaptation/Strategy","pentaho/i18n!messages","pentaho/type/loader","pentaho/type/ValidationError","pentaho/data/TableView","pentaho/type/util","pentaho/util/object"],function(e,t,n,i,r,o,a,s,u,l,c){
"use strict";var h=r.filter(function(e){return e.type.isBrowsable}).map(function(e){
return e.type}),d=a.resolveType([i]),p=t.extend({$type:{id:e.id,valueType:n,_init:function(e,t){
e=this.base(e,t)||e;var n=this.declaringType;if(null!==n){var i=n.get("model").valueType,r=i.get(this.name);
c.setConst(this,"_internalProperty",r),this.label=r.label,this.description=r.description,
this.ordinal=r.ordinal,this.category=r.category,this.helpUrl=r.helpUrl,this.isBrowsable=r.isBrowsable;
}if(this.isRoot){var o=e.strategies;null==o&&this.__setStrategyTypes(h,!0)}return e;
...
},get fields(){var e=c.getOwn(this,"__fields");if(!e){var t=this;this.__fields=e=Object.freeze({
countRangeOn:function(e){return t.__fieldsCountRangeOn(e)}})}return e},__fieldsCountRangeOn:function(e){
var t=this._internalProperty.fields.countRangeOn(e.model).min>0,n=e.get(this),i=n&&n.mode,r=(null!==i?i.dataType.isList:this.hasAnyListModes)?1/0:1;
return{min:t?1:0,max:r}},__modes:null,__strategyTypeList:null,__isStrategyTypesDefault:!0,
__strategyTypeApplicationList:null,get modes(){return this.__modes},get strategies(){
return this.__strategyTypeList},set strategies(e){this._assertNoSubtypesAttribute("strategies"),
null!=e&&this.__setStrategyTypes(e,!1)},__setStrategyTypes:function(e,t){var n=[],r=Object.create(null);
e.forEach(function(e){var t=a.resolveType(e).type;c.hasOwn(r,t.uid)||(r[t.uid]=!0,
n.push(t))});var o=[],s=new d,u=this.isVisualKey;this._internalProperty.modes.each(function(e){
var t=e.isContinuous;n.forEach(function(n){var r=n.getInputTypeFor(e.dataType,u);if(null!=r){
var a=new i({dataType:r,isContinuous:t});s.add(a),a=s.get(a.$key),o.push(Object.freeze({
externalMode:a,strategyType:n,internalMode:e}))}})}),this.__modes=s,this.__strategyTypeList=n,
this.__isStrategyTypesDefault=!!t,this.__strategyTypeApplicationList=o},selectAdaptationStrategyOn:function(e){
var t=e.get(this);if(!t.hasFields)return null;var n=t.fieldIndexes;if(null===n)return null;
for(var i=e.data,r=this.__strategyTypeApplicationList,o=r.length,a=-1,s=t.isCategoricalFixed;++a<o;){
...
var i=e.externalMode.dataType,r=n.length;if(!i.isList&&r>1)return null;for(var o=i.elementType,s=-1;++s<r;){
var u=n[s],l=a.resolveType(t.getColumnType(u)).type;if(!l.isSubtypeOf(o))return null;
...
var t=this.base(e);if(!t){var n=function(e){t=l.combineErrors(t,e)},i=e.get(this);
i.hasFields&&null===i.strategy&&n(new s(o.format(o.structured.errors.property.noStrategy,{
role:this}))),n(this._internalProperty.validateOn(e.model))}return t},_fillSpecInContext:function(e,t){
var n=this.base(e,t),i=c.getOwn(this,"__strategyTypeList");return i&&!this.__isStrategyTypesDefault&&(n=!0,
e.strategies=i.map(function(e){return e.toSpecInContext(t)})),n}}}).configure({$type:e.config
});return p}),define("pentaho/visual/base/ModelAdapter",["pentaho/module!_","./AbstractModel","./Model","../role/ExternalProperty","pentaho/data/filter/True","pentaho/data/filter/False","pentaho/data/filter/Or","pentaho/data/filter/And","pentaho/type/loader","pentaho/type/changes/Transaction","pentaho/type/changes/ComplexChangeset","pentaho/data/Table","pentaho/data/util","pentaho/util/object","pentaho/util/error","pentaho/util/logger","pentaho/debug","pentaho/debug/Levels","pentaho/i18n!model"],function(e,t,n,i,r,o,a,s,u,l,c,h,d,p,f,_,m,g,y){
...
t.__adaptationModel=n}catch(r){m.testLevel(g.error,e)&&_.error("ModelAdapterChangeset apply failed: "+(r&&r.message));
}}}),j=i.type,S=t.extend({constructor:function(){if(this.base.apply(this,arguments),
...
return this._convertFilterToInternal(t)}catch(n){return m.testLevel(g.info,e)&&_.info("It was not possible to convert external selection filter: "+(n&&n.message)),
null}return null},__calcExternalSelectionFilter:function(){var t=this.model.selectionFilter;
if(null!==t)try{return this._convertFilterToExternal(t)}catch(n){return m.testLevel(g.info,e)&&_.info("It was not possible to convert internal selection filter: "+(n&&n.message)),
...
})}}}),i},$type:{id:e.id,isAbstract:!0,props:[{name:"model",valueType:n,isBoundary:!0,
isRequired:!0,isReadOnly:!0,defaultValue:function(){return{}}}]}}).implement({$type:{
_configureProperties:function(e){var t=this._normalizePropertiesSpec(e),n=Object.create(null);
t.forEach(function(e,t){p.hasOwn(n,e.name)||(n[e.name]={spec:e,index:t})});var i=n.model;
if(null!=i){var r=i.spec.valueType;if(null!=r){var o=this.get("model").valueType,a=u.resolveType(r).type;
if(o!==a&&a.isSubtypeOf(o)){this.label=a.label,this.description=a.description,this.ordinal=a.ordinal,
this.category=a.category,this.helpUrl=a.helpUrl;var s=[];a.eachVisualRole(function(t){
var i=t.name,r=o.get(i,!0);if(t!==r){var a,u=p.getOwn(n,i,null);null!==u?(a=Object.create(u.spec),
this.has(i)||(a.base=j),e[u.index]=null):a={name:i,base:this.has(i)?void 0:j},s.push(a);
}},this),s.length>0&&(s.unshift(i.index+1,0),t.splice.apply(t,s),e=t.filter(function(e){
return null!==e}))}}}this.base(e)}}}).localize({$type:y.structured.ModelAdapter}).configure({
$type:e.config});return S}),define("pentaho/visual/color/utils",["require","pentaho/util/error"],function(e,t){
...
}).configure({$type:e.config})}),define("pentaho/visual/models/MetricPointAbstract",["pentaho/module!_","./CartesianAbstract","./types/LabelsOption","./mixins/ScaleColorContinuous","./mixins/ScaleColorDiscrete","./mixins/MultiCharted","./mixins/Trended","pentaho/i18n!./i18n/model"],function(e,t,n,i,r,o,a,s){
"use strict";return t.extend({$type:{id:e.id,isAbstract:!0,mixins:[a,r,i,o],category:"scatter",
props:[{name:"rows",modes:[{dataType:"list"}],fields:{isRequired:!0}},{name:"x",base:"pentaho/visual/role/Property",
modes:[{dataType:"number"},{dataType:"date"}],fields:{isRequired:!0},ordinal:1},{
name:"y",base:"pentaho/visual/role/Property",modes:[{dataType:"number"},{dataType:"date"
}],fields:{isRequired:!0},ordinal:2},{name:"color",base:"pentaho/visual/role/Property",
isVisualKey:!1,modes:[{dataType:"number"},{dataType:"list"}],ordinal:6},{name:"multi",
base:"pentaho/visual/role/Property",modes:[{dataType:"list"}],ordinal:10},{name:"labelsOption",
valueType:n,domain:["none","center","left","right","top","bottom"],isRequired:!0,
defaultValue:"none"}]}}).localize({$type:s.structured.MetricPointAbstract}).configure({
$type:e.config})}),define("pentaho/visual/models/types/SizeByNegativesMode",["pentaho/module!_","pentaho/type/String","pentaho/type/mixins/Enum","pentaho/i18n!../i18n/model"],function(e,t,n,i){
...
return r},$type:{id:e.id,isAbstract:!0}}).localize({$type:a.structured.adaptation.Strategy
...
var s=i.getValue(a,t),u=r(s);void 0===e[u]&&(e[u]=a)}},$type:{id:e.id,getInputTypeFor:function(e,t){
return e.isList?null:e},validateApplication:function(e,t){return{isValid:!0,addsFields:!1
}},apply:function(e,t){return new r({data:e,inputFieldIndexes:t})}}}).configure({
$type:e.config});return r}),define("pentaho/visual/role/adaptation/TupleStrategy",["pentaho/module!_","./Strategy","pentaho/util/object","pentaho/data/util"],function(e,t,n,i){
...
},$type:{id:e.id,getInputTypeFor:function(e,t){return e.isList?e:null},validateApplication:function(e,t){
return{isValid:!0,addsFields:!1}},apply:function(e,t){return new a({data:e,inputFieldIndexes:t
})}}}).configure({$type:e.config});return a}),define("pentaho/visual/role/adaptation/CombineStrategy",["pentaho/module!_","./Strategy","pentaho/type/String","pentaho/type/List","pentaho/util/object","pentaho/data/util"],function(e,t,n,i,r,o){
...
for(var _,m,g=-1;++g<p;){var y=a.getCell(d,o[g]),v=t[g](y.value);0===g?(_=v,m=y.formatted):(_+=f+v,
m+=u+(y.formatted||""))}var b=a.getCell(d,c);b.value=_,b.label=m,r.hasOwn(n,_)||(n[_]=d);
...
return t&&e.isSubtypeOf(n.type)?i.type:null},validateApplication:function(e,t){return{
isValid:!0,addsFields:!0}},apply:function(e,t){return new a({data:e,inputFieldIndexes:t
...
h[p]=n.getCell(l,t[p]);var f=h[p].label;f&&d.push(f)}var _=h[this.mainInputPosition],m=_.value,g=null!==m?a.parseDateEcma262v7(_.referent.property("startDateTime")):null,y=n.getCell(l,u);
y.value=g,y.label=d.join(", "),this.__backIndex[this.__keyFun.call(null,g)]=l,this.__forwardIndex[null===m?"":m]=l;
...
getInputTypeFor:function(e,t){return t&&e.isSubtypeOf(r.type)?u:null},validateApplication:function(e,t){
...
r=o)}}return null!=i&&i.isStartDateTimeProvided?r:-1},__getOutputFieldName:function(e){
return e.join("_")},__getOutputFieldLabel:function(e,t){for(var n=e.length,i=new Array(n);n--;){
var r=t.getColumnAttribute(e[n]);i[n]=r.label}return i.join(", ")},apply:function(e,t){
return new l({data:e,inputFieldIndexes:t})}}}).configure({$type:e.config});return l;
}),define("pentaho/visual/role/adaptation/EntityWithNumberKeyStrategy",["pentaho/module!_","./Strategy","pentaho/type/String","pentaho/type/Number","pentaho/util/object","pentaho/data/util"],function(e,t,n,i,r,o){
...
for(var c=u.addColumn(a),h=u.getNumberOfRows(),d=-1;++d<h;){var p=u.getCell(d,s),f=p.value,_=null!==f?p.referent.property("numberKey"):null,m=u.getCell(d,c);
m.value=_,m.label=p.label;var g=t(f);r.hasOwn(i,g)||(i[g]=d,o[n(_)]=d)}this._setOutputFieldIndexes([c]);
...
},$type:{id:e.id,getInputTypeFor:function(e,t){return t&&e.isSubtypeOf(i.type)?n.type:null;
...
"use strict"}),define("pentaho/visual/scene/util",["pentaho/util/error","pentaho/data/util"],function(e,t){
...
return null!=r?r.label:null}}}),define("pentaho/ccc/visual/Abstract",["pentaho/module!_","pentaho/visual/base/View","pentaho/visual/models/Abstract","pentaho/visual/action/Select","pentaho/visual/action/Execute","pentaho/visual/action/SelectionModes","pentaho/lang/UserError","cdf/lib/CCC/def","cdf/lib/CCC/pvc","cdf/lib/CCC/cdo","cdf/lib/CCC/protovis","./_util","pentaho/data/util","pentaho/data/filter/Or","pentaho/data/filter/And","pentaho/data/filter/IsEqual","pentaho/util/object","pentaho/visual/color/utils","pentaho/data/TableView","pentaho/util/logger","pentaho/debug","pentaho/debug/Levels","pentaho/i18n!view"],function(e,t,n,i,r,o,a,s,u,l,c,h,d,p,f,_,m,g,y,v,b,C,O){
...
m.hasOwn(a,c)||(a[c]=!0,o.push(l))}if(!o.length)return this._chart.clearSelections();
...
t?this.options.colors=t.colors.toArray(function(e){return e.value}):this.options.colors=g.buildPalette(e.colorSet,e.pattern,e.reverseColors);
...
var e,t=this.model,n=this.options,i=t.labelSize;if(i){var r=t.labelFontFamily;e=i+2+"px "+r;
...
var i=n.chart.data.type.dimensions(t.name);i.isHidden||("number"===t.sourceType?this._buildTooltipHtmlOfFieldNumeric(e,t,n):this._buildTooltipHtmlOfFieldNonNumeric(e,t,n));
...
if(e.hasFields){var t=e.mode;if(null!==t&&t.isContinuous){var n=e.fieldIndexes[0],o=i.getFilteredRowsByPredicate(this.model.data,function(e,t){
return null!==e.getValue(t,n)});null!==o&&(this._dataView.setSourceRows(o),r.warn("The visualization has ignored "+o.length+" row(s) having a null '"+this.model.data.getColumnLabel(n)+"' field value."));
...
name:l,type:"number",label:c});var d=this.addColumn(l),p=this,f="number"!==this.getColumnType(s),_=this.getRowIndexEnumerator(),m=f?null:function(e){
return p.getValue(e,s)},g=function(e){return p.getValue(e,u)},y=Object.create(h);y.rows=_,
y.x=m,y.y=g;var v=n.model(y);if(!v)return!1;for(var b=-1,C=this.getNumberOfRows();++b<C;){
var O=m?m(b):b,x=null!=O?v.sample(O,g(b),b):null;this.getCell(b,d).value=x}return!0;
...
var f=s/a,_=u/a,m=l/a,g=c/a,y=g-f*f,v=y&&(m-f*_)/y,b=_-v*f;return{alpha:b,beta:v,
...
$type:e.config})}),define("pentaho/ccc/visual/MetricPointAbstract",["pentaho/module!_","./CartesianAbstract","pentaho/visual/models/MetricPointAbstract","./_trends"],function(e,t,n){
...
o>0&&(c/=o);var h=Math.max(0,n.width-n.axisTitleSize),d=Math.max(0,n.height-n.axisTitleSize),p=h/d,f=l/c,_=300,m=70,g=200,y=.35,v=Math.min(_,a*m),b=Math.min(_,s*m),C=Math.min(_,a*g,d*y),O=Math.min(_,s*g,h*y);
