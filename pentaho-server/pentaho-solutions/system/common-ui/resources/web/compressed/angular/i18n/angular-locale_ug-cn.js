...
ERAS:["BCE","مىلادىيە"],FIRSTDAYOFWEEK:6,MONTH:["يانۋار","فېۋرال","مارت","ئاپرېل","ماي","ئىيۇن","ئىيۇل","ئاۋغۇست","سېنتەبىر","ئۆكتەبىر","نويابىر","دېكابىر"],
SHORTDAY:["يە","دۈ","سە","چا","پە","جۈ","شە"],SHORTMONTH:["يانۋار","فېۋرال","مارت","ئاپرېل","ماي","ئىيۇن","ئىيۇل","ئاۋغۇست","سېنتەبىر","ئۆكتەبىر","نويابىر","دېكابىر"],
STANDALONEMONTH:["يانۋار","فېۋرال","مارت","ئاپرېل","ماي","ئىيۇن","ئىيۇل","ئاۋغۇست","سېنتەبىر","ئۆكتەبىر","نويابىر","دېكابىر"],
...
posSuf:""}]},id:"ug-cn",localeID:"ug_CN",pluralCat:function(e,M){var E=0|e,r=a(e,M);
