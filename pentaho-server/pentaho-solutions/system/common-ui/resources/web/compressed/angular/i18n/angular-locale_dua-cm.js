...
var n=Math.pow(10,m),d=(e*n|0)%n;return{v:m,f:d}}var m={ZERO:"zero",ONE:"one",TWO:"two",
...
posPre:"",posSuf:" ¤"}]},id:"dua-cm",localeID:"dua_CM",pluralCat:function(e,i){var n=0|e,d=a(e,i);
return 1==n&&0==d.v?m.ONE:m.OTHER}})}]);