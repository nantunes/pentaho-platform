...
return-1==m?0:e.length-m-1}function M(e,M){var n=M;void 0===n&&(n=Math.min(m(e),3));
var a=Math.pow(10,n),i=(e*a|0)%a;return{v:n,f:i}}var n={ZERO:"zero",ONE:"one",TWO:"two",
...
posPre:"",posSuf:" ¤"}]},id:"bas-cm",localeID:"bas_CM",pluralCat:function(e,m){var a=0|e,i=M(e,m);
