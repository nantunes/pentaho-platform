...
DAY:["اتوار","سوموار","منگل","بدھ","جمعرات","جمعہ","ہفتہ"],ERANAMES:["قبل مسیح","عیسوی"],
ERAS:["قبل مسیح","عیسوی"],FIRSTDAYOFWEEK:6,MONTH:["جنوری","فروری","مارچ","اپریل","مئی","جون","جولائی","اگست","ستمبر","اکتوبر","نومبر","دسمبر"],
...
posPre:"¤ ",posSuf:""}]},id:"ur-in",localeID:"ur_IN",pluralCat:function(e,M){var r=0|e,E=a(e,M);
