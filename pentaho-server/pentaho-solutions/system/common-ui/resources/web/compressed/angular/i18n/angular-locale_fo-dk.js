...
FEW:"few",MANY:"many",OTHER:"other"};r.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],
DAY:["sunnudagur","mánadagur","týsdagur","mikudagur","hósdagur","fríggjadagur","leygardagur"],
ERANAMES:["fyri Krist","eftir Krist"],ERAS:["f.Kr.","e.Kr."],FIRSTDAYOFWEEK:0,MONTH:["januar","februar","mars","apríl","mai","juni","juli","august","september","oktober","november","desember"],
...
posPre:"",posSuf:" ¤"}]},id:"fo-dk",localeID:"fo_DK",pluralCat:function(r,e){var n=0|r,m=a(r,e);
