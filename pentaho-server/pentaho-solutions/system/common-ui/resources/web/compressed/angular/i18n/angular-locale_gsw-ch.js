...
AMPMS:["vorm.","nam."],DAY:["Sunntig","Määntig","Ziischtig","Mittwuch","Dunschtig","Friitig","Samschtig"],
ERANAMES:["v. Chr.","n. Chr."],ERAS:["v. Chr.","n. Chr."],FIRSTDAYOFWEEK:0,MONTH:["Januar","Februar","März","April","Mai","Juni","Juli","Auguscht","Septämber","Oktoober","Novämber","Dezämber"],
SHORTDAY:["Su.","Mä.","Zi.","Mi.","Du.","Fr.","Sa."],SHORTMONTH:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],
...
posPre:"",posSuf:" ¤"}]},id:"gsw-ch",localeID:"gsw_CH",pluralCat:function(e,i){return 1==e?r.ONE:r.OTHER;
}})}]);