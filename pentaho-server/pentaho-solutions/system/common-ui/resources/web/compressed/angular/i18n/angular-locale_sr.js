...
return-1==n?0:e.length-n-1}function r(e,r){var E=r;void 0===E&&(E=Math.min(n(e),3));
...
posPre:"",posSuf:" ¤"}]},id:"sr",localeID:"sr",pluralCat:function(e,n){var M=0|e,a=r(e,n);
return 0==a.v&&M%10==1&&M%100!=11||a.f%10==1&&a.f%100!=11?E.ONE:0==a.v&&M%10>=2&&4>=M%10&&(12>M%100||M%100>14)||a.f%10>=2&&a.f%10<=4&&(a.f%100<12||a.f%100>14)?E.FEW:E.OTHER;
}})}]);