...
var n=Math.pow(10,m),t=(a*n|0)%n;return{v:m,f:t}}var m={ZERO:"zero",ONE:"one",TWO:"two",
...
ERANAMES:["Kabla ya Kristo","Baada ya Kristo"],ERAS:["BC","AD"],FIRSTDAYOFWEEK:0,
...
posSuf:""}]},id:"sw-cd",localeID:"sw_CD",pluralCat:function(a,i){var n=0|a,t=e(a,i);
return 1==n&&0==t.v?m.ONE:m.OTHER}})}]);