...
AMPMS:["ਪੂ.ਦੁ.","ਬਾ.ਦੁ."],DAY:["ਐਤਵਾਰ","ਸੋਮਵਾਰ","ਮੰਗਲਵਾਰ","ਬੁੱਧਵਾਰ","ਵੀਰਵਾਰ","ਸ਼ੁੱਕਰਵਾਰ","ਸ਼ਨਿੱਚਰਵਾਰ"],
ERANAMES:["ਈਸਵੀ ਪੂਰਵ","ਈਸਵੀ ਸੰਨ"],ERAS:["ਈ. ਪੂ.","ਸੰਨ"],FIRSTDAYOFWEEK:6,MONTH:["ਜਨਵਰੀ","ਫ਼ਰਵਰੀ","ਮਾਰਚ","ਅਪ੍ਰੈਲ","ਮਈ","ਜੂਨ","ਜੁਲਾਈ","ਅਗਸਤ","ਸਤੰਬਰ","ਅਕਤੂਬਰ","ਨਵੰਬਰ","ਦਸੰਬਰ"],
SHORTDAY:["ਐਤ","ਸੋਮ","ਮੰਗਲ","ਬੁੱਧ","ਵੀਰ","ਸ਼ੁੱਕਰ","ਸ਼ਨਿੱਚਰ"],SHORTMONTH:["ਜਨ","ਫ਼ਰ","ਮਾਰਚ","ਅਪ੍ਰੈ","ਮਈ","ਜੂਨ","ਜੁਲਾ","ਅਗ","ਸਤੰ","ਅਕਤੂ","ਨਵੰ","ਦਸੰ"],
...
posSuf:""}]},id:"pa-guru-in",localeID:"pa_Guru_IN",pluralCat:function(e,E){return e>=0&&1>=e?M.ONE:M.OTHER;
}})}]);