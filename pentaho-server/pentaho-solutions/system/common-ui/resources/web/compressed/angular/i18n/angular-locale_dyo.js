...
var M=Math.pow(10,i),m=(e*M|0)%M;return{v:i,f:m}}var i={ZERO:"zero",ONE:"one",TWO:"two",
...
posPre:"",posSuf:" ¤"}]},id:"dyo",localeID:"dyo",pluralCat:function(e,a){var M=0|e,m=r(e,a);
return 1==M&&0==m.v?i.ONE:i.OTHER}})}]);