...
posPre:"",posSuf:" ¤"}]},id:"uk",localeID:"uk",pluralCat:function(e,M){var r=0|e,a=n(e,M);
return 0==a.v&&r%10==1&&r%100!=11?E.ONE:0==a.v&&r%10>=2&&4>=r%10&&(12>r%100||r%100>14)?E.FEW:0==a.v&&r%10==0||0==a.v&&r%10>=5&&9>=r%10||0==a.v&&r%100>=11&&14>=r%100?E.MANY:E.OTHER;
}})}]);