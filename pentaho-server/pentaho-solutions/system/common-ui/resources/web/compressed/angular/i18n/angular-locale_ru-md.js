...
return-1==e?0:M.length-e-1}function n(M,n){var r=n;void 0===r&&(r=Math.min(e(M),3));
var E=Math.pow(10,r),a=(M*E|0)%E;return{v:r,f:a}}var r={ZERO:"zero",ONE:"one",TWO:"two",
...
shortTime:"H:mm"},NUMBER_FORMATS:{CURRENCY_SYM:"MDL",DECIMAL_SEP:",",GROUP_SEP:" ",
PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",
posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-",negSuf:" ¤",
posPre:"",posSuf:" ¤"}]},id:"ru-md",localeID:"ru_MD",pluralCat:function(M,e){var E=0|M,a=n(M,e);
return 0==a.v&&E%10==1&&E%100!=11?r.ONE:0==a.v&&E%10>=2&&4>=E%10&&(12>E%100||E%100>14)?r.FEW:0==a.v&&E%10==0||0==a.v&&E%10>=5&&9>=E%10||0==a.v&&E%100>=11&&14>=E%100?r.MANY:r.OTHER;
}})}]);