...
var i=Math.pow(10,n),o=(e*i|0)%i;return{v:n,f:o}}var n={ZERO:"zero",ONE:"one",TWO:"two",
...
posPre:"¤ ",posSuf:""}]},id:"fy-nl",localeID:"fy_NL",pluralCat:function(e,r){var i=0|e,o=a(e,r);
return 1==i&&0==o.v?n.ONE:n.OTHER}})}]);