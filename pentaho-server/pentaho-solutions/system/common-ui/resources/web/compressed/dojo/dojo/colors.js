define(["./_base/kernel","./_base/lang","./_base/Color","./_base/array"],function(e,r,a,l){
var n={};r.setObject("dojo.colors",n);var o=function(e,r,a){0>a&&++a,a>1&&--a;var l=6*a;
return 1>l?e+(r-e)*l:1>2*a?r:2>3*a?e+(r-e)*(2/3-a)*6:e};e.colorFromRgb=a.fromRgb=function(e,r){
var n=e.toLowerCase().match(/^(rgba?|hsla?)\(([\s\.\-,%0-9]+)\)/);if(n){var i,t=n[2].split(/\s*,\s*/),d=t.length,g=n[1];
if("rgb"==g&&3==d||"rgba"==g&&4==d){var s=t[0];return"%"==s.charAt(s.length-1)?(i=l.map(t,function(e){
return 2.56*parseFloat(e)}),4==d&&(i[3]=t[3]),a.fromArray(i,r)):a.fromArray(t,r)}
if("hsl"==g&&3==d||"hsla"==g&&4==d){var u=(parseFloat(t[0])%360+360)%360/360,m=parseFloat(t[1])/100,h=parseFloat(t[2])/100,b=.5>=h?h*(m+1):h+m-h*m,y=2*h-b;
return i=[256*o(y,b,u+1/3),256*o(y,b,u),256*o(y,b,u-1/3),1],4==d&&(i[3]=t[3]),a.fromArray(i,r);
}}return null};var i=function(e,r,a){return e=Number(e),isNaN(e)?a:r>e?r:e>a?a:e};
return a.prototype.sanitize=function(){var e=this;return e.r=Math.round(i(e.r,0,255)),
e.g=Math.round(i(e.g,0,255)),e.b=Math.round(i(e.b,0,255)),e.a=i(e.a,0,1),this},n.makeGrey=a.makeGrey=function(e,r){
return a.fromArray([e,e,e,r])},r.mixin(a.named,{aliceblue:[240,248,255],antiquewhite:[250,235,215],
...
wheat:[245,222,179],whitesmoke:[245,245,245],yellowgreen:[154,205,50]}),a});