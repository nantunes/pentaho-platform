...
l:i.x,t:i.y})}this._isSizing=!0,this.startPoint={x:t.clientX,y:t.clientY};var s,a=c.getComputedStyle(this.targetDomNode),n="border-model"===g.boxModel,r=n?{
...
pbw:r.w,pbh:r.h,mw:z.w,mh:z.h},!this.isLeftToRight()&&"absolute"==dojo.style(this.targetDomNode,"position")){
...
var s=(this.isLeftToRight()?1:-1)*(this.startPoint.x-t.clientX),o=this.startPoint.y-t.clientY,a=this.startSize.w-(this._resizeX?s:0),h=this.startSize.h-(this._resizeY?o:0),n=this._checkConstraints(a,h);
switch(e=e||this.startPosition,e&&this._resizeX&&(n.l=e.l+s,n.w!=a&&(n.l+=a-n.w),
n.t=e.t),i){case"margin":n.w+=this.startSize.mw,n.h+=this.startSize.mh;case"border":
n.w+=this.startSize.pbw,n.h+=this.startSize.pbh}return n},_checkConstraints:function(t,i){
...
if(s!==!1){if(e)this.targetWidget.resize(s);else if(this.animateSizing){var o=n[this.animateMethod]([a.animateProperty({
...
this._isSizing=!1,this.onResize(t)},onResize:function(t){}}),x=_("dojox.layout._ResizeHelper",m,{
