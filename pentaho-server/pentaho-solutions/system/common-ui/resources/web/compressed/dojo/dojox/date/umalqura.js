define(["..","dojo/_base/lang","dojo/date","./umalqura/Date"],function(e,a,t,r){var n=a.getObject("date.umalqura",!0,e);
...
break;case"week":t*=7,n.setDate(e.getDate()+t);break;case"month":var u=e.getMonth();
n.setMonth(u+t);break;case"hour":n.setHours(e.getHours()+t);break;case"minute":n._addMinutes(t);
...
if(0==g)c=5*i;else{var d=0,u=e.getDay(),l=a.getDay();i=parseInt(c/7),g=c%7;var k=new r(e);
k.setDate(k.getDate()+7*i);var b=k.getDay();if(c>0)switch(!0){case 5==u:d=-1;break;
case 6==u:d=0;break;case 5==l:d=-1;break;case 6==l:d=-2;break;case b+g>5:d=-2}else if(0>c)switch(!0){
case 5==u:d=0;break;case 6==u:d=1;break;case 5==l:d=2;break;case 6==l:d=1;break;case 0>b+g:
