define(["exports","./_base/kernel","./sniff","./_base/lang","./dom","./dom-style","./dom-construct","./_base/connect"],function(e,t,n,r,a,o,s,i){
...
rowspan:"rowSpan",valuetype:"valueType"},e.get=function(t,n){t=a.byId(t);var r=n.toLowerCase(),o=e.names[r]||n;
return t[o]},e.set=function(t,f,u){t=a.byId(t);var m=arguments.length;if(2==m&&"string"!=typeof f){
for(var p in f)e.set(t,p,f[p]);return t}var y=f.toLowerCase(),b=e.names[y]||f;if("style"==b&&"string"!=typeof u)return o.set(t,u),
