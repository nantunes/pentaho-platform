define(["dijit/registry","dojo/_base/declare","dojo/_base/lang","./util","dojo/_base/html","dojo/_base/array"],function(t,e,i,s,o,a){
var h=function(t){for(var e,i=0,s=t.parentNode;e=s.childNodes[i++];)if(e==t)return i-1;
return-1},n=function(e){e&&a.forEach(t.toArray(),function(t){t.domNode&&o.isDescendant(t.domNode,e,!0)&&t.destroy();
})},r=function(t){var e=o.byId(t);return e&&e.tagName?e.tagName.toLowerCase():""},g=function(t,e){
for(var i,s=[],o=0;i=t.childNodes[o];)o++,r(i)==e&&s.push(i);return s},u=function(t){
return g(t,"div")};return e("dojox.grid._Scroller",null,{constructor:function(t){
...
t.rowIndex=t.topRowIndex+h(i),t.rowTarget=i,!0},processEvent:function(t){return this.processNodeEvent(t,this.contentNode);
...
this.removePage(t,i),n(i),i.innerHTML=""),i},getPageRow:function(t){return t*this.rowsPerPage;
},getLastPageRow:function(t){return Math.min(this.rowCount,this.getPageRow(t+1))-1;
},getFirstVisibleRow:function(t,e,i){if(!this.pageExists(t))return 0;for(var s=this.getPageRow(t),o=this.getDefaultNodes(),a=u(o[t]),h=0,n=a.length;n>h&&i>e;h++,
s++)e+=a[h].offsetHeight;return s?s-1:s},getLastVisibleRow:function(t,e,i){if(!this.pageExists(t))return 0;
for(var s=this.getDefaultNodes(),o=this.getLastPageRow(t),a=u(s[t]),h=a.length-1;h>=0&&e>i;h--,
o--)e-=a[h].offsetHeight;return o+1},findTopRow:function(t){for(var e,i=this.getDefaultNodes(),s=u(i[this.page]),o=0,a=s.length,h=this.pageTop;a>o;o++)if(e=s[o].offsetHeight,
...
this.pageTop=o,this.page=s,this.needPage(s,this.pageTop);var a=this.getDefaultNodes(),h=u(a[s]),n=t-this.rowsPerPage*s;
