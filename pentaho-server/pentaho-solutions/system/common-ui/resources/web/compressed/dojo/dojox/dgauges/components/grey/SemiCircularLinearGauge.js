define(["dojo/_base/lang","dojo/_base/declare","dojo/_base/Color","../utils","../../CircularGauge","../../LinearScaler","../../CircularScale","../../CircularValueIndicator","../../CircularRangeIndicator","../DefaultPropertiesMixin"],function(e,o,t,r,i,a,l,c,n,s){
return o("dojox.dgauges.components.grey.SemiCircularLinearGauge",[i,s],{borderColor:[148,152,161],
fillColor:[148,152,161],indicatorColor:[63,63,63],constructor:function(o,i){var n=new a({
majorTickInterval:25,minorTickInterval:5});this.addElement("background",e.hitch(this,this.drawBackground));
var s=new l;s.set("scaler",n),s.set("originX",118.80925),s.set("originY",172.98112),
s.set("radius",160.62904),s.set("startAngle",-127.30061),s.set("endAngle",-53),s.set("orientation","clockwise"),
s.set("labelGap",2),s.set("font",{family:"Helvetica",weight:"bold",size:"8pt"}),this.addElement("scale",s);
var C=new c;C.set("interactionArea","gauge"),C.set("value",n.minimum),C.set("indicatorShapeFunc",e.hitch(this,function(e,o){
var i=o.scale.radius-2;e.createPath().moveTo(0,0).lineTo(0,-5).lineTo(i,0).lineTo(0,0).closePath().setFill(this.indicatorColor);
var a=r.brightness(new t(this.indicatorColor),70);return e.createPath().moveTo(0,0).lineTo(0,5).lineTo(i,0).lineTo(0,0).closePath().setFill(a),
e})),s.addIndicator("indicator",C),this.addElement("foreground",e.hitch(this,this.drawForeground));
