...
this.focused&&t("Focused");var a=this.stateNode||this.domNode,i={};e.forEach(a.className.split(" "),function(e){
i[e]=!0}),"_stateClasses"in this&&e.forEach(this._stateClasses,function(e){delete i[e];
}),e.forEach(s,function(e){i[e]=!0});var c=[];for(var n in i)c.push(n);a.className=c.join(" "),
this._stateClasses=s},_subnodeCssMouseEvent:function(e,t,s){function a(s){o.toggle(e,t+"Hover",s);
}function i(s){o.toggle(e,t+"Active",s)}function c(s){o.toggle(e,t+"Focused",s)}if(!this.disabled&&!this.readOnly)switch(s.type){
case"mouseover":case"MSPointerOver":case"pointerover":a(!0);break;case"mouseout":
case"MSPointerOut":case"pointerout":a(!1),i(!1);break;case"mousedown":case"touchstart":
case"MSPointerDown":case"pointerdown":case"keydown":i(!0);break;case"mouseup":case"MSPointerUp":
case"pointerup":case"dojotouchend":case"keyup":i(!1);break;case"focus":case"focusin":
c(!0);break;case"blur":case"focusout":c(!1)}},_trackMouseState:function(e,t){e._cssState=t;
}});return n(function(){function e(e,t,o){if(!o||!s.isDescendant(o,t))for(var a=t;a&&a!=o;a=a.parentNode)if(a._cssState){
