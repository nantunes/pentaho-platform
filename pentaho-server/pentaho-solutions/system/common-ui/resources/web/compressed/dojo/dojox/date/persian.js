define("dojox/date/persian",["..","dojo/_base/lang","dojo/date","./persian/Date"],function(e,a,t,r){
var n=a.getObject("date.persian",!0,e);return n.getDaysInMonth=function(e){return e.getDaysInPersianMonth(e.getMonth(),e.getFullYear());
...
if(0==s)o=f.getMonth()-h.getMonth();else{o=12-y,o+=D;var v=h.getFullYear()+1,M=f.getFullYear();
for(v;M>v;v++)o+=12}a.toGregorian()<e.toGregorian()&&(o=-o);break;case"week":o=parseInt(n.difference(e,a,"day")/7);
