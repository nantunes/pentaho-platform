    ...
    pvc.BaseChart.add({
        ...
        _eachLeafDatasAndDataCells: function(hasMultiRole, dataCells, fun, ctx) {
            ...
            if (dataCellCount) {
                ...
                for (var smallIndex = 0; smallCount > smallIndex; smallIndex++) for (var leafData = leafDatas[startIndex + smallIndex], dataCellIndex = 0; dataCellCount > dataCellIndex; dataCellIndex++) fun.call(ctx, dataCells[dataCellIndex], leafData);
            }
        },
    ...
    def.type("pvc.MultiChartPanel", pvc.ContentPanel).add({
        createSmallCharts: function() {
            ...
            if (multiInfo && (pageSmallCount = multiInfo.pageSmallCount)) {
                ...
                for (var childOptionsBase = this._buildSmallChartsBaseOptions(), ChildClass = chart.constructor, smallDatas = multiInfo.smallDatas, colCount = multiInfo.colCount, startIndex = multiInfo.pageStartIndex, index = 0; pageSmallCount > index; index++) {
