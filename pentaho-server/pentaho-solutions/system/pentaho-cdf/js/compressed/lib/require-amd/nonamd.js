...
i||(n+="\n//# sourceURL="+t),n}function e(n){var r=n.deps;if(r){var i=[],e=[],t=[];
for(var u in r)if(r.hasOwnProperty(u)){var o=r[u];o?(e.push(o),i.push(u)):t.push(u);
}for(var f=0;f<t.length;f++)i.push(t[f]);if(i.length)return'["'+i.join('", "')+'"], function('+e.join(", ")+") {\n";
