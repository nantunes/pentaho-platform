...
alignmentValue:e.get(u,"alignmentValue")},x=s(t,f,i,d,y,v),b=x.fixed,k=x.overflow;;){
if(x.ticks=c=x.comp.ticks(r,n,x.mult,v),m&&x.precMax&&c[c.length-1]-c[0]>x.precMax.value){
x=m;break}if(b||k>0||x.ticks.length<=g)break;if(m&&m.ticks.length<=x.ticks.length){
x=m;break}m=x,x=x.comp.resultAbove(x.mult)}c=x.ticks,c.step=x.value,c.base=x.comp.value,
c.mult=x.mult,c.format=h(a)||x.comp.format}else c=[o(r)],c.step=c.base=c.mult=1,c.format=e.Format.date("%x");
return c}function s(t,e,r,n,i,o){var a,s,u,h,c=0,p=1,f=!!r;return r?(s=l(r,!1),s.value!==r?a=s.comp.withPrecision(r):(a=s.comp,
...
for(var n=this.prev;n;)1===n.mult&&n.value!==r&&n.clear(t,e),n=n.prev},u.prototype.floorMultiple=function(t,r,n){
var i=e.get(n,"alignmentValue"),o=null!=i?this.get(i):this.first(t,n),a=this.get(t)-o,s=null;
if(a){var l=r*this.mult;if(i){for(s=new Date(i);t>s;)this.set(s,this.get(s)+l);for(;s>t;)this.set(s,this.get(s)-l);
o=this.get(s)}else{var u=Math.floor(a/l)*l;o+=u}}this.set(t,o,s)},u.prototype.clear=function(t,e){
this.set(t,this.first(t,e))},u.prototype.multiple=function(t){for(var e=this.multiples,r=this.thresholds,n=this.closeds,i=e.length,o=-1;++o<i;)if(n[o]?t<=r[o]:t<r[o])return e[o];
...
}),d(864e5,{get:function(t){return t.getDate()},set:function(t,e,r){var n=r?r.getMonth():t.getMonth(),i=r?r.getFullYear():t.getFullYear();
t.setFullYear(i,n,e)},format:"%m/%d",first:1,multiples:[1,2,3,5],thresholds:[10,15,30,1/0],
closeds:[1,0,0,1]}),d(6048e5,{get:function(t){return t.getDate()},set:function(t,e,r){
var n=r?r.getMonth():t.getMonth(),i=r?r.getFullYear():t.getFullYear();t.setFullYear(i,n,e);
},mult:7,floor:function(t,r){var n=t.getDay()-e.get(r,"weekStart",0);0!==n&&(0>n&&(n+=7),
this.set(t,this.get(t)-n))},first:function(t,r){return this.get(c(t,e.get(r,"weekStart",0)));
},format:"%m/%d",multiples:[1,2,3],thresholds:[10,15,1/0],closeds:[1,1,1]}),d(2592e6,{
get:function(t){return t.getMonth()},set:function(t,e){t.setMonth(e)},format:"%m/%Y",
multiples:[1,2,3],thresholds:[12,24,1/0],closeds:[1,1,1]}),d(31536e6,{get:function(t){
return t.getFullYear()},set:function(t,e){t.setFullYear(e)},format:"%Y",multiple:function(t){
if(10>=t)return 1;var r=e.logCeil(t/15,10);return 2>t/r?r/=5:5>t/r&&(r/=2),r},castValue:function(t,r){
...
if(o){var a=e.cssStyle(t);n-=o.left+parseFloat(a("padding-left")||0),i-=o.top+parseFloat(a("padding-top")||0);
