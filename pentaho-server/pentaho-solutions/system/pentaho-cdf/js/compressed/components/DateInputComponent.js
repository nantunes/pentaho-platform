...
a.on("onOpen:dateInput",a.onOpenEvent),a.on("onClose:dateInput",a.onCloseEvent);var i=e('<input class="date-input" id="'+d+'"/>');
i.val(r),a.placeholder().addClass("date-input-container").html(i),e(function(){if(a.placeholder("input").datepicker({
beforeShow:function(){a.triggerOnOpen()},onClose:function(){a.triggerOnClose()},dateFormat:o,
changeMonth:!0,changeYear:!0,minDate:t,maxDate:n,onSelect:function(e,t){a.dashboard.processChange(d);
}}),"undefined"!=typeof a.dashboard.i18nSupport&&null!=a.dashboard.i18nSupport){var r=a.placeholder("input");
r.datepicker("option",e.datepicker.regional[a.dashboard.i18nCurrentLanguageCode]),
